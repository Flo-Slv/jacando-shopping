...
const Cart = ({ openCart, closeCart }) => {
  ...
  return (
    ...
    >
      <Box role="cart" onKeyDown={toggleDrawer(Boolean(false))}>
        <List
        ...
        {fruits.length === 0 ? null : (
          <List>
            <ListItem key={"fruits"} disablePadding>
              <ListItemButton>
                <ListItemIcon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
